// ============================================================
// GEOLYTICS — js/acceso/screens-acceso.js  ·  módulo acceso
// ------------------------------------------------------------
// Login (+ registro), recuperar contraseña, onboarding y pantalla de carga.
// Nota: el formulario de login tiene el botón de Google; la LÓGICA de
// Google Auth la implementa P3 (en su propio archivo + supabase-data.js).
// ============================================================
